...
//____________________makePage OR createServer _____________________________________________________
...
//             <body>
//                 <h1>about!</h1>
//                 <p>you are reached the about page!!!</p>
//             </body>
//         </html>
...
//             <body>
//                 <h1>home!</h1>
//                 <p>you are reached the home page!!!</p>
//             </body>
//         </html>
...
//             <body>
//                 <h1>posts!</h1>
//                 <p>you are reached the posts page!!!</p>
//             </body>
//         </html>
...
const makePage = (header,body) => {
  ...
  const server = http.createServer( (request, response) => {
    const url = request.url
    if(url == '/about'){
      response.end(makePage('ABOUTTT','you reached the about page'))
    }else if (url == '/about/about1'){
        response.end(makePage('about1','you reached the about1 page'))
var n = 0;
for (var i = 5000;i= n <= 5000;);
      }else if (url == '/about/'+n ){
        response.end(makePage('HOMEEEE','you reached the home page'+url))
    
      
    }else if (url == '/home'){
        response.end(makePage('HOMEEEE','you reached the home page'))
    }else if (url == '/home/home1'){
            response.end(makePage('home1','you reached the home1 page'))
        
      }else if (url == '/home/home1' ){
        response.end(makePage('home1','you reached the home1 page'))
    
      }else if (url == '/posts'){
        response.end(makePage('POSTSSS','you reached the posts page'))
      }else if (url == '/posts/1'){
            response.end(makePage('posts1','you reached the posts1 page'))
        
      }
    else{
      response.end(`<a href="https://codepen.io/ZonFire99/full/njdls/" class="viewFull" target="_parent">View in full it looks way better :)</a>
